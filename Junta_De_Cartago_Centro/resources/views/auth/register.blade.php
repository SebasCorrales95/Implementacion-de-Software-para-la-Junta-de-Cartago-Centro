                ...
                <div class="col-md-8 col-lg-6 col-xl-4">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="name" id="fullname" placeholder="Ingrese su Nombre Completo" required>
                                </div>
                                <div class="mb-3">
                                    <label for="email" class="form-label">Email</label>
                                    <input class="form-control" type="email" name="email" id="emailaddress" required placeholder="Ingrese su correo electrónico">
                                </div>
                                <div class="mb-3">
                                    <label for="cedula" class="form-label">Cédula</label>
                                    <input class="form-control" type="text" name="cedula" id="cedula" required placeholder="Ingrese su cédula">
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="checkbox-signup">Acepto los <a href="javascript: void(0);" class="text-dark">Terminos y Condiciones</a></label>
                                    </div>
                                </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-white-50">¿Ya tienes cuenta? <a href="{{ route('second', ['auth', 'login']) }}" class="text-white ms-1"><b>Iniciar Sesión</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
